...
type CompletionState = {
	...
	matches: MenuEmote[];
	index: number;
	/** The text the last cycle put in place of the prefix. */
	inserted: string | null;
};


export default class Completion extends Module<'site.chat.completion'> {
	...
	complete(editor: HTMLElement, direction: 1 | -1) {
		if ( this.current?.editor === editor )
